...
df = pd.read_csv('output/4-DL_scores.tsv', sep='\t')
...
df_unique_indx = df_unique_indx.drop_duplicates(['PDB_subject'])
df_unique_indx.to_csv('output/5-DL-unique.tsv', index=False, sep='\t')
