...
masif_opts = {}
# Default directories
data_dir = '../04-2021-SAbDab/'
masif_opts["raw_pdb_dir"] = data_dir + "data_preparation/00-raw_pdbs/"
masif_opts["pdb_chain_dir"] = data_dir +"data_preparation/01-benchmark_pdbs/"
masif_opts["ply_chain_dir"] = data_dir +"data_preparation/01-benchmark_surfaces/"
masif_opts["tmp_dir"] = tempfile.gettempdir()
masif_opts["ply_file_template"] = masif_opts["ply_chain_dir"] + "/{}_{}.ply"
masif_opts["patch_mapping_dir"] = data_dir +"data_preparation/05-patch_mappings"
masif_opts["negative"] = "data_preparation/06-negative"
...
] = data_dir+"data_preparation/04b-precomputation_12A/precomputation/"
...
# Grid Parameters
masif_opts["ppi_search"]['n_rotations'] = 16
masif_opts["ppi_search"]["grid_model_dir"] = "nn_models/sc05/all_feat/grid_model/"
masif_opts["ppi_search"]['grid_size'] = int(masif_opts["ppi_search"]["max_distance"]*2)
masif_opts["ppi_search"]['n_grid_feat'] = 10
...
masif_opts["site"][
    "masif_precomputation_dir"
] = data_dir +"data_preparation/04a-precomputation_9A/precomputation/"
...
masif_opts["ligand"] = {}
masif_opts["ligand"]["assembly_dir"] = data_dir +"data_preparation/00b-pdbs_assembly"
masif_opts["ligand"]["ligand_coords_dir"] = data_dir +"data_preparation/00c-ligand_coords"
masif_opts["ligand"][
    "masif_precomputation_dir"
] = data_dir +"data_preparation/04a-precomputation_12A/precomputation/"
